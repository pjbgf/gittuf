...
func TestUpdateHook(t *testing.T) {
	...
	err = rootMetadata.UpdateHook([]tuf.HookStage{tuf.HookStagePreCommit}, "nonexistent-hook", []string{key1.KeyID}, map[string]string{"sha1": "newhash"}, tuf.HookEnvironmentLua, 200)
	...
	err = rootMetadata.UpdateHook([]tuf.HookStage{tuf.HookStagePrePush}, "test-hook", []string{key1.KeyID, key2.KeyID}, map[string]string{"sha512": "anothernewhash"}, tuf.HookEnvironmentLua, 300)
	assert.Nil(t, err)
