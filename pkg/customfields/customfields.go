...
// lowercase DNS subdomain, a '/', and a name of at most 63 lowercase
// characters starting and ending alphanumeric, all shorter than MaxKeyLength.
...
// ValidValue reports whether value is a well-formed field value: shorter than
// MaxValueLength, no leading or trailing spaces, and every rune an ASCII
// letter, digit, or one of the characters in ValuePunctuation. This is a check
// of a value's shape, so the empty string passes. Emptiness means the field is
// absent, which writers handle by dropping the field.
